    ...
    <DropdownMenu.Root open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          ...
          sideOffset={5}
        >
          <DropdownMenu.Item className="text-sm group relative flex h-[32px] select-none items-center rounded-[3px] pl-[25px] leading-none text-white outline-none data-[disabled]:pointer-events-none data-[highlighted]:text-[#E9C7A5]">
            <Link
              href={"/tutorial/react"}
